...
class Figure : public Transformable, public GameObject {
public:
...
class Player : public Figure, public GameObject {
public:
    Player() : Figure(0, 0, sf::Color::Transparent) {}

    Player(float sizeX, float sizeY, sf::Color color, const sf::Vector2f& position) : Figure(sizeX, sizeY, color) {
        shape.setPosition(position);
    }
};

class Target : public Figure, public GameObject {
public:
            ...
            if (event.type == sf::Event::Closed) {
                ...
                if (event.key.code == sf::Keyboard::Space) {
                    try {
                        ...
                        std::cerr << "Exception occurred while shooting bullet: " << e.what() << std::endl;
                    }
                }
                    ...
                    try {
                        ...
                        std::cerr << "Exception occurred while quitting the game: " << e.what() << std::endl;
                    }
                }
            }
        }
